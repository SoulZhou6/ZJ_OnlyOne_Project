...
- (void)setSelectNumber:(NSInteger)selectNumber {
    ...
    if ([_delegate respondsToSelector:@selector(zkSegmentedView:didSelectTitleInteger:)]) {
        BOOL isSelect = [_delegate zkSegmentedView:self didSelectTitleInteger:selectNumber];
    ...
    if ([_delegate respondsToSelector:@selector(zkSegmentedView:selectTitleInteger:)]) {
        [_delegate zkSegmentedView:self selectTitleInteger:self.selectNumber];
    }
...
- (void)buttonClick:(UIButton *)sender {
    ...
    if ([_delegate respondsToSelector:@selector(zkSegmentedView:didSelectTitleInteger:)]) {
        BOOL isSelect = [_delegate zkSegmentedView:self didSelectTitleInteger:select];
